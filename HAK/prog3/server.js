...
setInterval(function () {
    stat.grass = grasssses.length ;
    stat.grassEater = grasseaterArr.length;
    stat.davajan = davajan.length;
    stat.melkon = melkon.length;
    stat.girl = girl.length;
    stat.boy = boy.length;
    fs.writeFile("statistics.json", JSON.stringify(stat), function () {
